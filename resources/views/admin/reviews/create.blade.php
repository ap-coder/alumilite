    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reviews.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rating') ? 'is-invalid' : '' }}" type="number" name="rating" id="rating" value="{{ old('rating', '5') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('signiture') ? 'is-invalid' : '' }}" type="text" name="signiture" id="signiture" value="{{ old('signiture', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('signiture_company') ? 'is-invalid' : '' }}" type="text" name="signiture_company" id="signiture_company" value="{{ old('signiture_company', '') }}">
