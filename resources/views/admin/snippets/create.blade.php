    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.snippets.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('snippet') ? 'is-invalid' : '' }}" name="snippet" id="snippet">{!! old('snippet') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('code_snippet') ? 'is-invalid' : '' }}" name="code_snippet" id="code_snippet">{{ old('code_snippet') }}</textarea>
