    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rss_link') ? 'is-invalid' : '' }}" type="text" name="rss_link" id="rss_link" value="{{ old('rss_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('working_hours') ? 'is-invalid' : '' }}" type="text" name="working_hours" id="working_hours" value="{{ old('working_hours', '') }}">
