...
@section('content')
    ...
    <style>
        .media-images .removeImage {position: absolute; right: 10px; color: red; }
        body.loading .overlaymodal {overflow: hidden; }
        body.loading .overlaymodal {display: block; }
        .overlaymodal {display: none; position: fixed; z-index: 1000; top: 0; left: 0; height: 100%; width: 100%; background: rgba( 255, 255, 255, .8) url('http://i.stack.imgur.com/FhHRx.gif') 50% 50% no-repeat; }
    </style>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data" id="submitPostForm" class="form-horizontal" novalidate="">
                ...
                <div class="form-group">
                    <label id="errorMsg" class="error" for="title"></label>
                    <hr>
