...
<head>
    ...
    <title>Build Contact Form Submission</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <h2>Build Contact Form Submission</h2>
        <p>Dear Alumilitearmor,</p>
        <div class="message">
            <p><strong>Build Name:</strong> <a href="{{ $mailData['build_slug'] }}">{{ $mailData['build_name'] }}</a> </p>
            <p><strong>Name:</strong> {{ $mailData['name'] }}</p>
            <p><strong>Email:</strong> {{ $mailData['email'] }}</p>
            <p><strong>Phone:</strong> {{ $mailData['phone'] }}</p>
            <p><strong>Zipcode:</strong> {{ $mailData['zipcode'] }}</p>
